...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  },
  {
    ...
    caption: "Official hospital signage and entrance brand board located at Yellapalli, Nirmal."
  },
  {
    id: "gal-2",
    title: "Specialist Medical Team",
    category: "Doctors",
    image: "/assets/gallery/all-doctors-team.jpg",
    caption: "Our team of consultant physicians, surgeons, pediatricians, obstetricians, and urologists."
  },
  {
    id: "gal-3",
  ...
  {
    id: "gal-12",
    title: "Urological Diagnostics & Kidney Stone Care",
    category: "Services",
    image: "/assets/facilities/urology-care.jpg",
    caption: "Comprehensive diagnostic and surgical evaluation for kidney stones and prostate conditions."
  },
  {
    id: "gal-13",
    title: "Empaneled Insurance & Aarogyasri Schemes",
    category: "Hospital",
    image: "/assets/gallery/insurance-brochure-banner.jpg",
    caption: "Rajiv Aarogyasri, Telangana EHS, and authorized private health insurance TPA desk."
  },
  {
    id: "gal-14",
    title: "Hospital Building Exterior Signage",
    category: "Facilities",
    image: "/assets/branding/hospital-sign-strip.jpg",
    caption: "Devibai Super Speciality Hospital vertical brand signage in Nirmal, Telangana."
  }
];
