...
export const MobileBottomBar: React.FC = () => {
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-2xl pt-2 pb-[max(0.6rem,env(safe-area-inset-bottom))] px-3 select-none">
      <div className="grid grid-cols-4 gap-1.5 items-center max-w-md mx-auto">
        ...
        <a
          ...
          className="flex flex-col items-center justify-center min-h-[44px] py-1 px-1 rounded-xl text-slate-700 hover:text-navy-900 active:bg-slate-100 transition-colors"
        ...
        <a
          ...
          className="flex flex-col items-center justify-center min-h-[44px] py-1 px-1 rounded-xl text-emerald-700 hover:text-emerald-800 active:bg-emerald-50 transition-colors"
        ...
        <Link
          ...
          className="flex flex-col items-center justify-center min-h-[44px] py-1 px-1 rounded-xl text-teal-700 hover:text-teal-800 active:bg-teal-50 transition-colors"
        ...
        <a
          ...
          className="flex flex-col items-center justify-center min-h-[44px] py-1 px-1 rounded-xl bg-emergency-600 text-white active:bg-emergency-700 transition-colors shadow-sm"
