...
export const EmergencyBar: React.FC = () => {
  return (
    <div className="bg-emergency-600 text-white text-xs sm:text-sm font-medium py-1.5 px-4 shadow-inner relative z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <span className="hidden md:inline text-red-100 text-xs">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <a
            ...
            className="inline-flex items-center space-x-1.5 bg-white text-emergency-700 hover:bg-red-50 px-2.5 py-0.5 rounded-full text-xs font-bold transition-all shadow-sm"
            aria-label="Call Emergency at 8885558061"
          >
            <PhoneCall className="w-3.5 h-3.5 text-emergency-600 animate-pulse" />
