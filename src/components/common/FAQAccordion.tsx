        ...
        return (
          ...
          >
            <button
              ...
              className="w-full text-left py-4 px-5 sm:px-6 flex items-center justify-between space-x-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 rounded-xl"
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <span className="font-heading font-semibold text-navy-900 text-base sm:text-lg">
                  {faq.question}
                </span>
              </div>
            ...
            {isOpen && (
              <div
                ...
                className="px-5 pb-5 sm:px-6 sm:pb-6 text-sm sm:text-base text-slate-600 leading-relaxed border-t border-slate-100 pt-3"
              >
                {faq.answer}
              </div>
            )}
